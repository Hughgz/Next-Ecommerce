  ...
  return (
    <>
      <div className="hero">
        ...
        <img
          className="hero-img"
          src="https://res.cloudinary.com/dahzoj4fy/image/upload/v1734125970/dlxbl4w8hx7cszxdwlkw.png"
          alt=""
        />
      </div>
        ...
        <div className="bg-neutral-100 py-16">
          <div className="max-w-screen-xl px-4 mx-auto w-full grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
            <div to="/sneakers/nike">
              <img
                src="https://images.squarespace-cdn.com/content/v1/5e31b33a1b5911193c47e7b5/279b45e0-3243-4e58-aee2-dd18403e2085/nike-swoosh-logo.jpeg"
                alt="Nike"
                className="w-full object-cover sm:h-full"
              />
              <div className="mt-4">
                <a className="font-semibold uppercase" href="/sneakers/nike">
                  Nike
                </a>
              </div>
            </div>
            <div to="/sneakers/adidas">
              ...
              />
              <div className="mt-4">
                <a className="font-semibold uppercase" href="/sneakers/adidas">
                  Adidas
                </a>
              </div>
            </div>
            <div to="/sneakers/jordan">
              ...
              />
              <div className="mt-4">
                <a className="font-semibold uppercase" href="/sneakers/jordan">
                  Jordan
                </a>
              </div>
            </div>
            <div to="/sneakers/new-balance">
              <img
                src="https://logowik.com/content/uploads/images/new-balance.jpg"
                alt="New Balance"
                className="w-full object-cover sm:h-full"
              />
              <div className="mt-4">
